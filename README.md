...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/bold-fire-e3d9
```

A live public deployment of this template is available at [https://bold-fire-e3d9.templates.workers.dev](https://bold-fire-e3d9.templates.workers.dev)
